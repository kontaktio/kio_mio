...
class FloorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create floor" do
    assert_difference("Floor.count") do
      post floors_url, params: { floor: { building_id: @floor.building_id, client_id: @floor.client_id, floor_id: @floor.floor_id, name: @floor.name } }
    end
  ...
  test "should update floor" do
    patch floor_url(@floor), params: { floor: { building_id: @floor.building_id, client_id: @floor.client_id, floor_id: @floor.floor_id, name: @floor.name } }
